...
public class MpGenerator {
    ...
    final static String  dirPath = "F:\\BaiduNetdiskDownload\\mapper";
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/test1?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&useSSL=true");
